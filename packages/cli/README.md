...
running command...
$ b6 (--version)
@builder6/cli/0.7.0 darwin-arm64 node-v20.18.1
$ b6 --help [COMMAND]
USAGE
  $ b6 COMMAND
...
...
_See code: [src/commands/hello/index.ts](https://github.com/builder6app/cli/blob/v0.7.0/src/commands/hello/index.ts)_
...
_See code: [src/commands/hello/world.ts](https://github.com/builder6app/cli/blob/v0.7.0/src/commands/hello/world.ts)_
...
_See code: [src/commands/start/index.ts](https://github.com/builder6app/cli/blob/v0.7.0/src/commands/start/index.ts)_
<!-- commandsstop -->
